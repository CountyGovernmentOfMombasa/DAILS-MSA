...
INSERT INTO users (payroll_number, surname, first_name, other_names, email, birthdate, password, password_changed) VALUES
...
-- ('PAYROLL_NUM', 'SURNAME', 'FIRST_NAME', 'OTHER_NAMES', 'EMAIL', 'YYYY-MM-DD', 'HASHED_PASSWORD', FALSE),
